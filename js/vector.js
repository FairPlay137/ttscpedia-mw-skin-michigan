/**
 * Michigan-specific scripts (this pertains to how menus collapse)
 */
jQuery( function ( $ ) {
	 ...
	 */
	$( 'div.michiganMenu' ).each( function () {
		var $el = $( this );
		$el.find( '> h5 > span' ).parent()
			...
			.focus( function () {
				$el.addClass( 'michiganMenuFocus' );
			} )
			.blur( function () {
				$el.removeClass( 'michiganMenuFocus' );
			} );
	} );
